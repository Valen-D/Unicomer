package com.unicomer.backendtechforb.exceptions;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<Object> handleDataIntegrityViolationExceptionEntity(
        DataIntegrityViolationException dataIntegrityViolationException, WebRequest request) {
            ...
            logger.error("Failed to save entity with integration problems: " + errorMessage, dataIntegrityViolationException);
    ...
    public ResponseEntity<Object> handleInsufficientBalanceException(InsufficientBalanceException exception, WebRequest request) {
        ...
        logger.error("Insufficient balance error: " + errorMessage, exception);
